...
struct QRCameraView : UIViewRepresentable{
    ...
    func torchLight(isOn: Bool) -> QRCameraView {
    ...
    func interval(delay: Double) -> QRCameraView {
        delegate.scanInterval = delay
        return self
    }
    
    func found(r: @escaping (String) -> Void) -> QRCameraView {
        print("qr found")
        delegate.onResult = r
        return self
    }
    
    func simulator(mockBarCode: String)-> QRCameraView{
    ...
    func makeUIView(context: UIViewRepresentableContext<QRCameraView>) -> QRCameraView.UIViewType {
    ...
    func updateUIView(_ uiView: CameraPreview, context: UIViewRepresentableContext<QRCameraView>) {
